                        ...
                        <div class="yhm-flex">
                            <div style="width:60%">
                                ...
                                <span class="error-text"></span>
                                    ...
                                    <input type="text" name="pormo_code" class="form-control get-input-focus" value="{$UpgradeConfig.promo_code}" placeholder="优惠码" style="width:108px"/>
                                    <button class="btn btn-primary ml-2 use_promo_code focus-button" disabled type="button" style="width: 56px; height:38px">应用</button>
                                    {else /}
                                        <span class="tips-text" style="display: block;">优惠码</span>
                                    <span class="form-control" style="width:108px">{$UpgradeConfig.promo_code}</span>
                                    <button class="btn btn-primary ml-2 remove_promo_code" type="button" style="width: auto; height:38px" >移除</button>
                                    {/if}
                                </div>
                            ...
                            <div style="width: 40%;">
                                <div class="text-right font-size-18" style="font-size: 12px !important; color:#999 !important; margin-bottom:10px !important">
                                    总计：<span class="text-primary" style="color:#6064FF !important;font-size:12px !important">{$UpgradeConfig.currency.prefix}<font style="font-weight: bold !important; font-size:18px !important">{$UpgradeConfig.total}</font>{$UpgradeConfig.currency.suffix}/{$UpgradeConfig.billingcycle_zh}</span>
                                </div>
                            </div>
                        </div>
