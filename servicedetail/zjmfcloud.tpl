    ...
    <div class="col-12">
      ...
      <div class="row align-items-center server_header_box">
        ...
        <div class="d-flex justify-content-end flex-shrink-1 flex-grow-1">
          ...
          <div class="btn-group ml-2 mr-2 mt-2 zdzy">
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="col-3 float-left pl-0 pr-0 mr-3 zdbfb">
            <div class="col-12 mb-2 pl-0 pr-0">
              <div class="bg-light card-body bg-gray zdphig">
                <p class="text-gray">
                  {$Lang.login_information}
          ...
          <div id="cloud_nat">
            ...
            <div class="rounded-sm d-flex flex-column justify-content-center text-white">
          ...
          <div class="row mr-0 ml-0 zddgj">
            <!-- <div class="col-12 my-2">
              ...
              <div class="bg-light card-body bg-gray pre-money-box zdphig">
                <p class="text-gray">
                ...
                <section class="d-flex align-items-center float-left mb-3 zddgjg">
                  <h3 class="mb-0 mr-2 dc mr-5">
                ...
                'free'}
                  <span class="ml-5 zdxfz">{$Lang.automatic_balance_renewal}</span>
                  <div class="custom-control custom-switch custom-switch-md mb-4 ml-1" dir="ltr">
                ...
                <section class="text-gray col-12 d-flex justify-content-between mt-5 pl-0">

                  <p class="mb-0">{$Lang.subscription_date}：{$Detail.host_data.regdate|date="Y-m-d H:i"}</p>

                  <p class="mb-0">{$Lang.payment_cycle}：{$Detail.host_data.billingcycle_desc}</p>

                  {if $Detail.host_data.billingcycle == 'free' || $Detail.host_data.billingcycle == 'onetime'}
                  <p class="mb-0">{$Lang.due_date}：{if $Detail.host_data.format_nextduedate.msg == '不到期'} - {else}
          ...
          <!-- 配置项 -->
          <div class="row col-12 pr-0 ml-0 mt-3 user-center_product_grid bg-gray pt-2">
            {foreach $Detail.config_options as $item}
            {if $item.option_type == '5'||$item.option_type == '6'||$item.option_type == '8'}
            {else}
            <div class="col-md-12 configuration configuration_list">
              <div data-toggle="popover" data-placement="top" data-trigger="hover"
                data-content="{$item.name}：{$item.sub_name}" class="py-2 row col-12">
                <p class="text-gray plr-0 text-nowrap mr-1">
                  {$item.name}
                </p>
                <p class="mb-0 plr-0 text-nowrap text-left pl-2">
            ...
            <div onclick="isShowConfiguration()" class="configuration-btn-down isClick">查看更多信息</div>
             ...
             <div class="col-12 mb-2">
              <div data-toggle="popover" data-placement="top" data-trigger="hover"
                ...
                <p class="text-gray col-md-1 plr-0 text-nowrap">{$Lang.remarks_infors}</p>
          ...
          <div class="tab-content p-3 text-muted">
            ...
            <div
              ...
              <div class="w-100 h-100">
                ...
                <div class="chart_content_box w-100" id="usedChartBox"></div>
...
<script>
  ...
  function isShowConfiguration(first = true) {
    ...
    if($('.configuration_list').length < 30) {
