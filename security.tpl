		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="accountbind-form">
					<div style="text-align: end;" class="form-advanced">
						<label>
							<input name="advanced" type="checkbox" value="isCheck" style="vertical-align: middle;margin-top: -4px;"/>
							{$Lang.senior}
						</label>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<input id="copy-apiss" name="i_account" class="form-control"/>
							</div>
						</div>
						<div class="down-group row" style="width:100%;margin: 12px 0 0;">
							<label class="col-sm-4 col-form-label text-right">
								{$Lang.Sensitive_operation_verification_identifier}
							</label>
							<div class="col-sm-8" style="padding-right: 65px;">
								<div class=" row">
									<span class="col-sm-2" style="line-height: 36px;">
										<input name="security_verify" type="checkbox" style="vertical-align: middle;margin-top: -4px;width: 100%;" />
									</span>
									<input id="copy-apiss" name="security_code" class="form-control col-sm-10"  />
								</div>
							</div>
						</div>
					</div>
